...
contract TestIntegerPB {
  ...
  function getTestIntegerSint32(address key) public view returns (int32) {
    ...
    pb_TestInteger.Data memory data = pb_TestInteger.decode(encoded);
  ...
  function storeTestInteger(address key, int32 sint32_field,
    ...
    pb_TestInteger.Data memory data = pb_TestInteger.Data({sint32_field: sint32_field, int32_field: int32_field,
    ...
    bytes memory encoded = pb_TestInteger.encode(data);
